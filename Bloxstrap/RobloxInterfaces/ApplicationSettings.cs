    ...
    public class ApplicationSettings
    {
        ...
        private async Task Fetch()
        {
            ...
            try
            {
                ...
                try
                {
                    response = await App.HttpClient.GetAsync("https://clientsettingscdn." + Deployment.RobloxDomain + path).ConfigureAwait(false);
                }
                catch (Exception ex)
                {
                    ...
                    response = await App.HttpClient.GetAsync("https://clientsettings." + Deployment.RobloxDomain + path).ConfigureAwait(false);
                }
