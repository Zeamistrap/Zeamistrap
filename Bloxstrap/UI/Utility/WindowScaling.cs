...
namespace Bloxstrap.UI.Utility
{
    ...
    {
        private static double PrimaryBoundsWidth => Screen.PrimaryScreen?.Bounds.Width ?? SystemParameters.PrimaryScreenWidth;

        public static double ScaleFactor => PrimaryBoundsWidth / SystemParameters.PrimaryScreenWidth;
