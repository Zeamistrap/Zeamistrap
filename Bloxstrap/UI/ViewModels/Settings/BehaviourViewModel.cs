namespace Bloxstrap.UI.ViewModels.Settings
{
    public class BehaviourViewModel : NotifyPropertyChangedViewModel
    {
        ...
        {
            get => App.Settings.Prop.UseHighPriority;
            set => App.Settings.Prop.UseHighPriority = value;
        }
        ...
        public bool CleanerZeamistrap
        {
            get => CleanerItems.Contains("ZeamistrapLogs");
            set
            {
                if (value)
                    CleanerItems.Add("ZeamistrapLogs");
                else
                    CleanerItems.Remove("ZeamistrapLogs");
            }
        }
    }
}
