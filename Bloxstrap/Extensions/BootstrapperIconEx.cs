...
namespace Bloxstrap.Extensions
{
    static class BootstrapperIconEx
    {
        ...
        {
            BootstrapperIcon.IconZeamistrap,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconZeamistrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconZeamistrap => Properties.Resources.IconZeamistrap,
                ...
                _ => Properties.Resources.IconZeamistrap
            };
        }
    }
}
