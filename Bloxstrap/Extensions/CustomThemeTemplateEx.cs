...
namespace Bloxstrap.Extensions
{
    ...
    {
        const string EXAMPLES_URL = "https://github.com/Zeamistrap/Zeamistrap/custom-bootstrapper-examples";
        ...
        {
            string contents = Encoding.UTF8.GetString(Resource.Get(template.GetFileName()).GetAwaiter().GetResult());
